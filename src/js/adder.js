...
document.querySelector("#acceptButton").addEventListener('click', () => {
  ...
  let color_text = document.querySelector("#color-text").value;
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    divPrint.style.color = color_text;
...
document.querySelector("#color-text").addEventListener("input", function () {
  let color_text = document.querySelector("#color-text").value;

  if (document.querySelector(".print-page") !== null) {
    let printPages = document.querySelectorAll('.print-page');
    for (let i = 0; i < printPages.length; i++) {
      printPages[i].style.color = color_text;
    }
  }
});
